...
function ContractorProfile({ contractor }) {
  ...
  return (
    <div className="glass-strong rounded-xl p-6 animate-fade-in">
      <h3 className="text-lg font-bold text-white mb-4">جزئیات پیمانکار</h3>
      <div className="space-y-4">
        <div>
          <h4 className="text-xl font-bold text-white mb-2">{contractor.name}</h4>
        ...
        <div className="border-t border-white/10 pt-4">
          <h5 className="text-sm font-medium text-gray-300 mb-2">آمار پروژه‌ها</h5>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              <p className="text-2xl font-bold text-white">{contractor.activeProjects}</p>
              <p className="text-xs text-gray-400">فعال</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-white">{contractor.completedProjects}</p>
              <p className="text-xs text-gray-400">تکمیل شده</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-white">{contractor.totalProjects}</p>
